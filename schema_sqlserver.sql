...
-- 3. Tabla de Productos (Parámetros y Costos Dinámicos)
...
-- 4. Tabla del Libro Diario (Encabezados de Asientos)
...
-- 5. Tabla de Detalle del Asiento (Partidas Contables)
...
-- 6. Tabla del Kárdex (Control de Inventario Físico)
CREATE TABLE kardex (
    id INT IDENTITY(1,1) PRIMARY KEY,
...
-- Inserción del Producto Base para Pruebas del Kárdex
INSERT INTO productos (nombre, costo_compra, precio_venta, stock_actual)
VALUES ('Producto Estándar', 8.85, 17.70, 0);