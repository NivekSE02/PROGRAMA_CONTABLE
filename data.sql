...
INSERT INTO cuentas
    (codigo, nombre, tipo, subtipo, nivel, naturaleza, cuenta_padre, permite_movimiento)
VALUES
...
('1.4', 'IVA Crédito Fiscal', 'ACTIVO', 'ACTIVO CORRIENTE', 2, 'DEUDORA', '1', 1),
...
('1.6.2', 'Equipo de cómputo', 'ACTIVO', 'ACTIVO NO CORRIENTE', 3, 'DEUDORA', '1.6', 1),
...
('2.2', 'Préstamo bancario', 'PASIVO', 'PASIVO CORRIENTE / NO CORRIENTE', 2, 'ACREEDORA', '2', 1),

('2.3', 'IVA Débito Fiscal', 'PASIVO', 'PASIVO CORRIENTE', 2, 'ACREEDORA', '2', 1),
...
('3.1', 'Capital social', 'PATRIMONIO', 'PATRIMONIO', 2, 'ACREEDORA', '3', 1),
...
('5', 'Costos', 'COSTO', 'RESULTADO', 1, 'DEUDORA', NULL, 0),

('5.1', 'Devoluciones sobre compras', 'COSTO', 'RESTA A COSTOS', 2, 'ACREEDORA', '5', 1),

('5.2', 'Costo de ventas', 'COSTO', 'COSTOS', 2, 'DEUDORA', '5', 1),

('5.3', 'Mercancía disponible', 'COSTO', 'CUENTA TRANSITORIA', 2, 'DEUDORA', '5', 1),

-- ============================================================
-- 6. GASTOS
-- ============================================================

('6', 'Gastos', 'GASTO', 'RESULTADO', 1, 'DEUDORA', NULL, 0),

('6.1', 'Gastos financieros', 'GASTO', 'GASTOS', 2, 'DEUDORA', '6', 0),
('6.1.1', 'Comisión', 'GASTO', 'GASTOS FINANCIEROS', 3, 'DEUDORA', '6.1', 1),

('6.2', 'Gasto administrativo', 'GASTO', 'GASTOS', 2, 'DEUDORA', '6', 1),

('6.3', 'Gasto de venta', 'GASTO', 'GASTOS', 2, 'DEUDORA', '6', 0),
('6.3.1', 'Papelería y útiles', 'GASTO', 'GASTOS DE VENTA', 3, 'DEUDORA', '6.3', 1);